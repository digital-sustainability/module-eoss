...
== Exam Layout
 ...
 - Content
   * 7 x 7% : ca. 2-6 questions per Module >> approx. 14-42 questions >> 49%
   * 11% : approx. 7-14 questions regarding slide- and task-topics beside OSPO101
   * all in all approx. 21-56 questions ~ 2-3 minutes per question
 - Format
   * Language: Englisch
   * PC with Safe Exam Browser
