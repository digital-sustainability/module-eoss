link:https://commons.wikimedia.org/wiki/File:Berner_Fachhochschule_Logo_small.svg[image:https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Berner_Fachhochschule_Logo_small.svg/250px-Berner_Fachhochschule_Logo_small.svg.png[BFH]]
...
| **Language**: verbal / spoken: **English**; slides, content, literature & material: **English** +
