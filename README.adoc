...
| Entry requirements
| **Professional skills** +
-	Basic know how of software engineering principles and	business concepts +
...
- Aid: own «summary» (max 10 single or 5 double pages) +
...
| Comment
| All contents are available here https://github.com/digital-sustainability/module-eoss licensed as CC-BY 4.0 link:https://virtuelleakademie.ch/knowledge-base/oer-policy-der-bfh/[OER].
